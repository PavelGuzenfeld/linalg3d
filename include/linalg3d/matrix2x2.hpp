...
static_assert(std::is_trivially_copyable_v<Matrix2>, "Matrix2 must be trivially copyable");
static_assert(std::is_standard_layout_v<Matrix2>, "Matrix2 must be standard layout");
} // namespace linalg3d
