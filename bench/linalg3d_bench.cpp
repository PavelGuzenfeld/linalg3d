...
int main()
{
    ...
    bench.run("Vector2::norm", [&] { ankerl::nanobench::doNotOptimizeAway(v2a.norm()); });

    bench.run("Vector2::normalized", [&] { ankerl::nanobench::doNotOptimizeAway(v2a.normalized()); });

    bench.run("Vector2::dot", [&] { ankerl::nanobench::doNotOptimizeAway(v2a.dot(v2b)); });

    bench.run("Vector2::cross", [&] { ankerl::nanobench::doNotOptimizeAway(v2a.cross(v2b)); });

    bench.run("Vector2::operator+", [&] { ankerl::nanobench::doNotOptimizeAway(v2a + v2b); });
    ...
    bench.run("Vector4::norm", [&] { ankerl::nanobench::doNotOptimizeAway(v4a.norm()); });

    bench.run("Vector4::dot", [&] { ankerl::nanobench::doNotOptimizeAway(v4a.dot(v4b)); });

    bench.run("Vector4::operator+", [&] { ankerl::nanobench::doNotOptimizeAway(v4a + v4b); });
    ...
    bench.run("Matrix2::determinant", [&] { ankerl::nanobench::doNotOptimizeAway(m2a.determinant()); });

    bench.run("Matrix2::inverse", [&] { ankerl::nanobench::doNotOptimizeAway(m2a.inverse()); });

    bench.run("Matrix2::transpose", [&] { ankerl::nanobench::doNotOptimizeAway(m2a.transpose()); });

    bench.run("Matrix2::operator*mat", [&] { ankerl::nanobench::doNotOptimizeAway(m2a * m2b); });

    bench.run("Matrix2*Vector2", [&] { ankerl::nanobench::doNotOptimizeAway(m2a * v2a); });
    ...
    bench.run("Matrix4::transpose", [&] { ankerl::nanobench::doNotOptimizeAway(m4a.transpose()); });

    bench.run("Matrix4::operator*mat", [&] { ankerl::nanobench::doNotOptimizeAway(m4a * m4b); });

    bench.run("Matrix4*Vector4", [&] { ankerl::nanobench::doNotOptimizeAway(m4a * v4a); });
    ...
    bench.run("Quaternion::dot", [&] { ankerl::nanobench::doNotOptimizeAway(qa.dot(qb)); });
    ...
    bench.run("Angle::to_degrees", [&] { ankerl::nanobench::doNotOptimizeAway(angle_rad.to_degrees()); });
